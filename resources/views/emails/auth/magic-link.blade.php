...
<div class="wrapper">
    <table class="main" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="content">
                <h1 class="title">{{ __('mail.auth.magic_link.title') }}</h1>
                <p class="text">
                    {!! __('mail.auth.magic_link.body') !!}
                </p>

                <a href="{{ $url }}" class="button">{{ __('mail.auth.magic_link.action') }}</a>

                <div class="divider"></div>

                <p class="help-text">
                    {!! __('mail.auth.magic_link.expire', ['count' => \App\Models\MagicLoginToken::EXPIRES_MINUTES]) !!}
                </p>
            </td>
        </tr>
    </table>
    ...
    <div class="footer">
        ...
        {{ __('mail.auth.magic_link.footer') }}
    </div>
</div>
</body>
</html>
