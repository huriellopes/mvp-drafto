            ...
            <div wire:key="suggest-{{ $writer->id }}"
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    <h4 class="truncate text-xs font-black text-zinc-900 dark:text-white">{{ $writer->name }}</h4>
                                    <p class="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">{{ $writer->published_posts_count }} Obras</p>
                                </div>
                            </div>
                        ...
                        {{-- Botão ocupa a largura total no modo Sidebar para não espremer --}}
                        <div class="w-full">
                ...
                @else
                    ...
                    <div class="min-w-0 flex-1">
                        <h4 class="truncate text-sm font-black text-zinc-900 dark:text-white">{{ $writer->name }}</h4>
                        <p class="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">{{ $writer->published_posts_count }} Obras</p>
                        <div class="mt-2">
