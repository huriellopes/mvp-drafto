    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col items-center justify-between gap-8 md:flex-row">
            <div class="flex items-center gap-2">
                <img src="{{ asset('images/favicon/android-chrome-192x192.png') }}" width="32" height="32" class="h-8 w-auto grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all" alt="Drafto Logo">
            </div>

            <p class="text-sm text-zinc-600 dark:text-zinc-500 text-center">
        ...
        <nav class="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-zinc-600 dark:text-zinc-500">
